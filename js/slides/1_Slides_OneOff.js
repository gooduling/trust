...
SLIDES.push({
	...
	onstart: function(self){
		...
		// Buttons
		self.add({
			id:"btnCheat", type:"Button", x:275, y:513, text_id:"label_cheat", uppercase:true,
			onclick:function(){
				_.answer = "CHEAT";
		...
		self.add({
			id:"btnCooperate", type:"Button", x:495, y:510, text_id:"label_cooperate", uppercase:true,
			onclick:function(){
				_.answer = "COOPERATE";
				publish("slideshow/next");
			}
	...
	onstart: function(self){
		...
		self.add({
			id:"btnNext", type:"Button", x:304, y:531, size:"long",
